...
The access secret and the later capability handle will each contain at least
128 bits of entropy generated by a cryptographically secure random source. Their
exact lengths and unambiguous encodings will be fixed during implementation
without reducing that minimum. Input length will be bounded before lookup or
