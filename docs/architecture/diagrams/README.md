...
| [C4 context](c4-context.md)                                                   | Evaluators, operators and contributors  | ADR-0029, single-VPS topology and release boundary                            | `npm run docs:check`                                                              | Maintained fictional-demo context view    |
| [C4 container](c4-container.md)                                               | Contributors and security reviewers     | Production/development Compose and attachment controls                         | Production Compose check and `npm run docs:check`                                 | Maintained private-runtime view           |
| [Security data-flow](security-data-flow.md)                                   | Security and privacy reviewers          | Threat models, ADR-0008/0013/0029 and release workflow                        | `npm run docs:check`                                                              | Maintained credential/data boundary view  |
| [Release and rollback sequence](release-rollback-sequence.md)                | Release operators and reviewers         | Release workflow, reconciliation script and rollback runbook                  | Release workflow checks and `npm run docs:check`                                  | Maintained controlled-release procedure   |
