...
| [Single-VPS deployment](single-vps-deployment.md)                             | Operators and security reviewers        | ADR-0012 and `infrastructure/production/compose.production.yaml`              | `infrastructure/production/check-api-environment.sh` and production Compose check | Maintained fictional deployment topology    |
