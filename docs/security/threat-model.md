...
| T-07 | High     | Public/follow-up resource exhaustion                                | Submission and verification limits; bounded fields                              | Follow-up read/append lack pagination/rate limits; [#99](https://github.com/albertogalvez-dev/Convive/issues/99) is the production gate, while #63 owns shared limiter state                                                                               |
...
| T-15 | Medium   | Email identifies reporter or becomes recovery bypass                | Feature absent                                                                  | Purpose, verification, minimal messages and provider retention: [#39](https://github.com/albertogalvez-dev/Convive/issues/39)-[#40](https://github.com/albertogalvez-dev/Convive/issues/40)                                                                |
