...
| T-15 | Medium   | Email links a mailbox to Convive or becomes a recovery bypass       | [ADR-0015](../architecture/decisions/0015-use-verified-email-only-for-generic-reporter-notifications.md) prohibits email/manual recovery and selects verified generic notices, separation and deletion; feature remains absent | Implement verification, bounded delivery and negative recovery/content tests in [#40](https://github.com/albertogalvez-dev/Convive/issues/40); production provider and real-data approval remain gates                                                     |
