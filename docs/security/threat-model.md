...
| T-07 | High     | Public/follow-up resource exhaustion                                | Submission, verification and capability/IP-scoped follow-up limits; transactional 100-entry cap; bounded deterministic reads                                                                                                                                                                 | Shared, restart-resistant Redis limiter state is owned by #205 before public release                                                                                                                                                                       |
...
| T-10 | High     | Insider/stale membership/excess admin reads data                    | Case policy requires an active account, active organisation membership, exact active case assignment and requested permission; administrator-only and cross-scope tests deny access                                                                                                          | Assignment mutation, invalidation and audit remain in [#46](https://github.com/albertogalvez-dev/Convive/issues/46)-[#47](https://github.com/albertogalvez-dev/Convive/issues/47)                                                                          |
...
| T-12 | Medium   | Limits/idempotency bypassed by restart, replica or equivalent input | Per-IP limits and optional key                                                                                                                                                                                                                                                               | Shared Redis state and canonical binding are owned by #205; the concurrent race remains explicitly bounded                                                                                                                                                 |
