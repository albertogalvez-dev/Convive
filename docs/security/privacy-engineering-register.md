...
| P-05 | Capability hash/scope/expiry/revocation             | HttpOnly opaque cookie, one report, short lifetime                          | Cleanup and restore purge not operational       | Partial / #63/#66            |
| P-06 | Follow-up content/time: add information             | Required, whitespace checked, 2,000-char bound                              | Entry count and retention unbounded             | Fictional only / #99         |
