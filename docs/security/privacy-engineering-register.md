...
| P-13 | Optional reporter email/delivery metadata           | Not collected yet; separate verified contact, generic notices only, never professional identity or access recovery under [ADR-0015](../architecture/decisions/0015-use-verified-email-only-for-generic-reporter-notifications.md) | Unverified 24h; immediate removal; final closure maximum 7d; delivery evidence 30d; restore limits defined by ADR-0015 | Decision accepted / #40                   |
...
| R-06 | High     | Email/third party links mailbox use to a report: ADR-0015 limits purpose, content, access and retention; collection/delivery remain disabled until #40 and provider review               | #40 / real-data gate  |
...
Real-data attachment use is still forbidden. Absence remains the current
privacy control for email, analytics and case management; ADR-0015 is a design
decision, not an enabled delivery system. Review this register whenever a PR changes a data field,
